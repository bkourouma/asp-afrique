    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-base text-gray-600 mt-2">Gerer les articles et actualites ASPCI</p>
        </div>
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
          ...
          <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
            <DialogHeader>
              <DialogTitle>
                {editingArticle ? "Modifier l'Article" : "Creer un Article"}
              </DialogTitle>
              <DialogDescription>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <Label htmlFor="excerpt">Resume (200 caracteres max) *</Label>
                <Textarea
                  id="excerpt"
                  name="excerpt"
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <Input
                    ...
                    onChange={handleInputChange}
                    placeholder="Ex: Formation, Actualite, Tutoriel"
                    required
                  />
                </div>
                <div>
              ...
              <div>
                ...
                <div className="flex gap-2 mb-2">
                  <Input
                    ...
                    placeholder="Ajouter un tag et appuyez sur Entree"
                  />
        ...
        {articles.length === 0 && (
          <Card>
            <CardContent className="flex flex-col items-center justify-center py-12">
              <p className="text-gray-500 mb-4">Aucun article trouve</p>
              <Button onClick={openCreateDialog}>
                <Plus className="mr-2 h-4 w-4" />
