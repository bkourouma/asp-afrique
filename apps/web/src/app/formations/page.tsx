...
export default function FormationsPage() {
  ...
  // Mapping des images de fond pour chaque formation par slug
  const getImageUrl = (slug: string): string => {
    const imageMap: Record<string, string> = {
      "agent-de-securite-professionnel-as": "/images/AgentSecuriteProfessionnel.jpg",
      "agent-securite-professionnel": "/images/AgentSecuriteProfessionnel.jpg",
      "agent-de-securite-portuaire-asp": "/images/AgentSecuritePortuaire.jpg",
      "agent-securite-portuaire": "/images/AgentSecuritePortuaire.jpg",
      "agent-intervention": "/images/Agentdintervention.jpg",
      "agent-de-protection-rapprochee-apr": "/images/AgentdeSecuriteRapprochée.jpg",
      "agent-protection-rapprochee": "/images/AgentdeSecuriteRapprochée.jpg",
      "agent-dinvestigation-ai": "/images/Agentdinvestigation.jpg",
      "agent-investigation": "/images/Agentdinvestigation.jpg",
      "ingenierie-securitaire-is": "/images/Administrateurdesûreté.jpg",
      "ingenierie-securitaire": "/images/Administrateurdesûreté.jpg"
    };
    
    const url = imageMap[slug] || imageMap[slug.toLowerCase()];
    if (url) return url;
    
    // Fallback: essayer de trouver par correspondance partielle
    const slugLower = slug.toLowerCase();
    if (slugLower.includes('professionnel')) return '/images/AgentSecuriteProfessionnel.jpg';
    if (slugLower.includes('portuaire')) return '/images/AgentSecuritePortuaire.jpg';
    if (slugLower.includes('intervention')) return '/images/Agentdintervention.jpg';
    if (slugLower.includes('rapproche') || slugLower.includes('protection')) return '/images/AgentdeSecuriteRapprochée.jpg';
    if (slugLower.includes('investigation')) return '/images/Agentdinvestigation.jpg';
    if (slugLower.includes('ingenierie') || slugLower.includes('surete')) return '/images/Administrateurdesûreté.jpg';
                  ...
                  <div className="bg-white rounded-3xl p-6 shadow-xl hover:shadow-2xl transition-all duration-300 border border-white/30 hover:border-[#FF6B35]/30 relative overflow-hidden transform-gpu h-full flex flex-col">
                    ...
                    <div className="flex gap-4 mb-4">
                      ...
                      <div className="flex-shrink-0 w-32 h-32 rounded-xl overflow-hidden bg-gray-100">
                        <img 
                          src={getImageUrl(formation.slug) || '/images/placeholder.jpg'}
                          alt={formation.title}
