...
export function VideoForm({ video, onSave, onCancel }: VideoFormProps) {
  ...
  const [showPublicationSection, setShowPublicationSection] = useState(false);
  ...
  useEffect(() => {
    if (video) {
      ...
      // Afficher la section Publication en mode édition
      setShowPublicationSection(true);
    }
  }, [video]);
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              ...
              <Button
                ...
                variant="ghost"
                size="sm"
                onClick={() => setShowPublicationSection(false)}
              >
                <X className="h-4 w-4" />
              </Button>
            </div>
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              ...
              <Button
                ...
                variant="outline"
                size="sm"
                onClick={() => setShowPublicationSection(true)}
              >
                Modifier
              </Button>
            </div>
