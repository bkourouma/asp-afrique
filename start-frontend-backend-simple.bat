...
REM ╔════════════════════════════════════════════════════════════════════════════╗
REM ║                                                                            ║
REM ║              START FRONTEND + BACKEND (SIMPLE)                            ║
REM ║                                                                            ║
REM ║  Ce script démarre le frontend (Next.js) et le backend (Fastify)         ║
REM ║  dans deux fenêtres séparées                                              ║
REM ║                                                                            ║
REM ╚════════════════════════════════════════════════════════════════════════════╝
...
echo ╔════════════════════════════════════════════════════════════════════════════╗
echo ║                                                                            ║
echo ║              START FRONTEND + BACKEND (SIMPLE)                            ║
echo ║                                                                            ║
echo ║  Ce script démarre le frontend (Next.js) et le backend (Fastify)         ║
echo ║  dans deux fenêtres séparées                                              ║
echo ║                                                                            ║
echo ╚════════════════════════════════════════════════════════════════════════════╝
echo.
...
echo ║                                                                            ║
echo ║  Fermer cette fenetre pour terminer le script                             ║
echo ║                                                                            ║
echo ╚════════════════════════════════════════════════════════════════════════════╝
echo.
